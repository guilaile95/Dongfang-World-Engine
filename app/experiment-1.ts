...
/** Frozen protocol. Do not edit after the run starts. No reroll. */
...
async function main(): Promise<void> {
  ...
  process.stderr.write(
    `experiment-1 source=${publicConfig.worldSource} world=${publicConfig.worldFile} model=${publicConfig.model} @ ${publicConfig.baseUrl}\n`,
  );
  ...
  const out = resolve("data/local/experiment-1-receipt.json");
